...
window.Modernizr = (function( window, document, undefined ) {
    ...
    function webforms() {
        /*>>input*/
        // Run through HTML5's new input propertys to see if the UA understands any.
        // We're using f which is the <input> element created early on
        // Mike Taylr has created a comprehensive resource for testing these propertys
    ...
    /*jshint evil:true */
      ...
      function createElement(nodeName, ownerDocument, data){
        ...
        // * Link elements with `src` propertys that are inaccessible, as with
